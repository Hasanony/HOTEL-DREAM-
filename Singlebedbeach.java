...
public class Singlebedbeach extends JFrame implements ActionListener {
    ImageIcon i1;
    ...
    public Singlebedbeach() {
        ...
        i1 = new ImageIcon(ClassLoader.getSystemResource("PICS/singlebedbeach.jpg"));
 ...
 public void actionPerformed(ActionEvent ae){
       ...
       try{
		...
		JOptionPane.showMessageDialog(null, "Beach Villa Successfully Added");
